...
console.log('Loading UnderscoreContainers qUnit configurations.');

define(['text!amd-test-config.json','underscore'], function(testConfigString, undef) {

    console.log('Loading UnderscoreContainers qUnit tests.');
    ...
    return require(tests, function() {
        console.log('Initializing UnderscoreContainers qUnit tests.');
